...
patchfilesPath = '/projectnb/trenders/proj/ltattribution/mr224_wetness_greatest/patchfiles_wetness_paramset02_greatest_disturbance.csv'
band = '1'
setValue = '19'
outputPathDir = '/projectnb/trenders/proj/david/magnitude_by_year/mr224_wetness_greatest/setvalue_allyears/'
